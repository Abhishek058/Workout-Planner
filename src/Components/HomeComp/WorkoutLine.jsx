...
const WorkoutTimeline = () => {
  ...
  return (
    <div className="workoutLine">
      <div className="flex flex-col items-center bg-black bg-opacity-85 p-8">
        <h1 className="text-4xl font-semibold my-10 text-white">
          Workout Plan
        </h1>
        <div className="w-full max-w-4xl">
          {workouts.map((workout, index) => (
            ...
            >
              <div className="bg-black bg-opacity-25 rounded-lg p-4 w-80 m-2 shadow-white shadow-md">
